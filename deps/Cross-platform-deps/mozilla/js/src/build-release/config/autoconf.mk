...
ac_configure_args =  --disable-shared-js --enable-threadsafe --with-system-nspr --disable-tests --enable-trace-jscalls
...
MOZ_BUILD_ROOT             = /home/justin/Oolite-dev/1.77/deps/Cross-platform-deps/mozilla/js/src/build-release
...
NSPR_LIBS	= -L/usr/lib/i386-linux-gnu -lplds4 -lplc4 -lnspr4 -lpthread -ldl
